...
#' @title Logit Bayesian Causal Forest Using Bayesian Model Averaging (Logit-BCF-BMA)
#'
#' @description BCF-BMA for binary outcomes. Averages over logistic functions of sums-of-trees.
...
#' @useDynLib logitbcfbma, .registration = TRUE
#' @import  Rcpp dqrng mvnfast



logitbcfBMA<-function(x,...)UseMethod("logitbcfBMA")

logitbcfBMA<-function(x.train,y.train,z,pihat,
  ...
  bcfBMA_call=BCF_BMA_sumLikelihood_add_mu_or_tau(spike_tree,
                                                  ...
                                                  zero_split,
                                                  only_max_num_trees,
                                                  separate_tree_numbers,
                                                  min_num_obs_for_mu_split,
                                                  min_num_obs_after_mu_split,
                                                  min_num_obs_for_tau_split,
  ...
  if(is_test_data==1){
    if(include_cate_intervals==1){
      names(bcfBMA_call)<-c("ITE_ests_insamp",
                            "ITE_intervals_insamp",
                            "CATE_est_insamp",
                            "model_probs",
                            "sumoftrees_mu",
                            "sumoftrees_tau",
